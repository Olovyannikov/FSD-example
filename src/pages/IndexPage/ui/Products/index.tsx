...
import { getDeclinations } from '../../lib/declinations';
import { useIsLarge } from '../../lib/media';
import { FiltersModel } from '../../model/filters';
import { ProductModel, PRODUCTS_SCROLL_THRESHOLD } from '../../model/product';
...
export function Products() {
    ...
    const { isEmpty, products, isLoading, productsCount } = useUnitShape(ProductModel);
